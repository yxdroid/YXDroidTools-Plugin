 ...
 * ---------------------------------------
 */
public class GenerateSelectorAction extends BaseAnAction {
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        if (files != null) {
            ...
            String selectorName = showInputDialog("请定义selector名称");

            if (TextUtils.isEmpty(selectorName)) {
                return;
            }
            ...
            XmlFile xmlFile = (XmlFile) PsiFileFactory.getInstance(mProject)
                    .createFileFromText(selectorName.toLowerCase(), StdFileTypes.XML, "<?xml version=\"1.0\" encoding=\"utf-8\" ?>" +
